...
<body class="bg-slate-50 text-slate-800">
        ...
        <main class="flex-1 p-6 lg:p-10 overflow-y-auto h-screen">
            ...
            <section id="module1" class="content-section">
                ...
                <div class="activity-card">
                    ...
                    <div class="space-y-4">
                        <div>
                            <label for="emotion-select" class="block text-sm font-medium text-slate-700 mb-1">1. ¿Qué
                ...
                <div class="activity-card">
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><strong>Aplazamiento Asertivo:</strong> Pedir tiempo para pensar antes de dar una respuesta.
                            <em class="text-slate-500">"Necesito pensarlo. Te respondo mañana."</em></li>
                    </ul>
                </div>
            </section>
                    ...
                    <div class="bg-white p-4 rounded-lg shadow-sm">
                        ...
                        <ul class="mt-2 space-y-3 divide-y divide-slate-100">
                            ...
                            <li class="pt-3"><strong>Línea de Asistencia en Salud Mental MSP (Ecuador):</strong> Llama
                                al 171 opción 6. <a href="tel:171" class="text-blue-600 font-semibold">Llamar ahora</a>
                            </li>
                        </ul>
                    </div>
                    <div class="bg-white p-4 rounded-lg shadow-sm">
    ...
    <script>
        ...
        const affirmations = [
            ...
            "Está bien permitirme sentir y descansar cuando lo necesito.",
